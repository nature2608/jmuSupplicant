...
const static uint8_t SERVICE_EDUCATION[] = {0x69,0x6e,0x74,0x65,0x72,0x6e,0x65,0x74}; //internet接入
...
const static unsigned int SERVICE_EDUCATION_LENGTH = 8; // bytes number
